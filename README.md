...
- Текущее описание API: [API.md](./API.md)
...
Файл `.env` сам по себе автоматически подхватывается только через Docker Compose или если ты сам загрузил его в shell/IDE.
